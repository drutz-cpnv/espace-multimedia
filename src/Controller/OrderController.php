...
class OrderController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, NewOrder $newOrder, StateRepository $stateRepository): Response
    {
        $order = new Order();
        ...
        if($form->isSubmitted() && $form->isValid()) {
            ...
            $check = $newOrder->checkConflicts($order);
            ...
            $order->addOrderState($newOrder->getPendingState($this->getUser()));
