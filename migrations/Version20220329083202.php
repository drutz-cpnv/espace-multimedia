 ...
 */
final class Version20220329083202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cabinet ADD created_by_id INT DEFAULT NULL, ADD updated_by_id INT NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', DROP location');
        $this->addSql('ALTER TABLE cabinet ADD CONSTRAINT FK_4CED05B0B03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE cabinet ADD CONSTRAINT FK_4CED05B0896DBBDE FOREIGN KEY (updated_by_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_4CED05B0B03A8386 ON cabinet (created_by_id)');
        $this->addSql('CREATE INDEX IDX_4CED05B0896DBBDE ON cabinet (updated_by_id)');
        $this->addSql('ALTER TABLE equipment ADD cabinet_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cabinet DROP FOREIGN KEY FK_4CED05B0B03A8386');
        $this->addSql('ALTER TABLE cabinet DROP FOREIGN KEY FK_4CED05B0896DBBDE');
        $this->addSql('DROP INDEX IDX_4CED05B0B03A8386 ON cabinet');
        $this->addSql('DROP INDEX IDX_4CED05B0896DBBDE ON cabinet');
        $this->addSql('ALTER TABLE cabinet ADD location VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP created_by_id, DROP updated_by_id, DROP created_at, DROP updated_at, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE equipment DROP cabinet_id, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE filename filename VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
