 ...
 */
final class Version20220316105316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE teacher ADD lastname VARCHAR(255) NOT NULL, CHANGE fullname firstname VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE teacher ADD fullname VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP firstname, DROP lastname, CHANGE email email VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE acronym acronym VARCHAR(3) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE friendly_id friendly_id VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
