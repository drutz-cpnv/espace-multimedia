 ...
 */
final class Version20220308200301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE settings (id INT AUTO_INCREMENT NOT NULL, updated_by_id INT NOT NULL, name VARCHAR(255) NOT NULL, setting_key VARCHAR(255) NOT NULL, value VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_E545A0C5896DBBDE (updated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
