 ...
 */
final class Version20220217121540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE state ADD content_template_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE state ADD CONSTRAINT FK_A393D2FB56F0A53E FOREIGN KEY (content_template_id) REFERENCES content (id)');
        $this->addSql('CREATE INDEX IDX_A393D2FB56F0A53E ON state (content_template_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE state DROP FOREIGN KEY FK_A393D2FB56F0A53E');
        $this->addSql('DROP INDEX IDX_A393D2FB56F0A53E ON state');
        $this->addSql('ALTER TABLE state DROP content_template_id, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE color color VARCHAR(6) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE slug slug VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
