 ...
 */
final class Version20220329093115 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cabinet ADD location_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE cabinet ADD CONSTRAINT FK_4CED05B064D218E FOREIGN KEY (location_id) REFERENCES room (id)');
        $this->addSql('CREATE INDEX IDX_4CED05B064D218E ON cabinet (location_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cabinet DROP FOREIGN KEY FK_4CED05B064D218E');
        $this->addSql('DROP INDEX IDX_4CED05B064D218E ON cabinet');
        $this->addSql('ALTER TABLE cabinet DROP location_id, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
